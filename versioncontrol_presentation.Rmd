...
- Easy to move code across computers 
...
- But now there are GUIs that are easy to use and visualize what git is doing
    - Gitkraken, which I showed you
    - RStudio has a basic git GUI 
- Settling on standards for how projects should be organized, what coding conventions to follow
